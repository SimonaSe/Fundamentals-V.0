...
In the organisations unit tab select:
...
-   Click in update to see the output (note that only part of the table is shown here, in DHIS2, all facilities should be displayed).
...
-   **Data Element**: Delivery in facility
-   **Period**: January - March 2016, April - June 2016, July - September 2016, October - December 2016
-   **Organization Unit**: Trainingland Districts
...
In [TRAININGLAND](https://live.academy.dhis2.org/tl1/dhis-web-commons/security/login.action), please try to use place search.

-   Click on the magnifying glass in the top right corner. It will expand to a search field.
...
-   Enter a location of your choosing in the search field and see if it is available. When it appears select it from the list. It will zoom to that location and drop a pinpoint on the map of the location you have selected.
...
### Activity 7 - Applying a pre-defined legend

In [TRAININGLAND](https://live.academy.dhis2.org/tl1/dhis-web-commons/security/login.action),  please create a map with a pre-defined legend.
...
Apply a custom legend set to a map with:
...
The chart will open in the Data Visualiser app.
...
### Activity 2 - Sharing an analysis favorite
...
-   Click on the Edit button next to Sharing to bring up the sharing settings display.
...
-   Public Access: None
-   Online Fundamentals Academy Participants: Can view
...
By changing these settings, only those users that belong to the "Online fundamentals academy participants" user group will be able to see your chart. As you have only given them the ability to view the chart, they will not be able to overwrite/change what you have shared with them.
...
You can move the items around and resize them to your liking in order to get a feel for how the objects on the dashboard work. This is a very useful tool for bringing together multiple analysis in a particular thematic area together in order to be reviewed quickly. It is particular useful for program managers to receive at-a-glance information regarding the programs they are responsible for.
